 ...
 * Return: Pointer to buffer of the user input
 */
char *_getline(void)
{
	int temp;
...
/**
 * split_line - Divides line into args
 * @line: Ln of user input
 * Return: Array of arguments of user input
 */
 ...
 * @env: The Environment
 * Return: 1 if builtins exist, 0 if it doesn't
 */
